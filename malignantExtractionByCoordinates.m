...
malignantMLpatches = fullfile(strcat('/vol/vssp/ucdatasets/mammo2/TotalRecall/OptimamData/Images/Benign/bcoordinateBasedMLpatches_benign'));
addedTotal = 1;
            ...
            if isequal(exist('processedPair', 'dir'),7)
                ...
                for currentFile = 1:length(jsonFiles)
                    ...
                    if coordinateFlag > 0
                        ...
                        extractTopLeftX = coordxCenter - 500;
                        extractTopLeftY = coordyCenter - 500;
                        
                        sourceFilePath = fullfile(strcat('/vol/vssp/ucdatasets/mammo2/TotalRecall/OptimamData/Images/Benign/bUseful/', subject,'/CCpair/left/processedPair/', newFileName));
        ...
        if isequal(exist('processedPair', 'dir'),7)
            ...
            for currentFile = 1:length(jsonFiles)
                ...
                if coordinateFlag > 0
                    ...
                    sourceFilePath = fullfile(strcat('/vol/vssp/ucdatasets/mammo2/TotalRecall/OptimamData/Images/Benign/bUseful/', subject,'/CCpair/right/processedPair/', newFileName));
            ...
            if isequal(exist('processedPair', 'dir'),7)
                ...
                for currentFile = 1:length(jsonFiles)
                    ...
                    if coordinateFlag > 0
                        ...
                        sourceFilePath = fullfile(strcat('/vol/vssp/ucdatasets/mammo2/TotalRecall/OptimamData/Images/Benign/bUseful/', subject,'/MLOpair/left/processedPair/', newFileName));
            ...
            if isequal(exist('processedPair', 'dir'),7)
                ...
                for currentFile = 1:length(jsonFiles)
                    ...
                    if coordinateFlag > 0
                        ...
                        sourceFilePath = fullfile(strcat('/vol/vssp/ucdatasets/mammo2/TotalRecall/OptimamData/Images/Benign/bUseful/', subject,'/MLOpair/right/processedPair/', newFileName));
